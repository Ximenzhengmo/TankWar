...
const TankImage_T redTankImage[20] = {
        ...
        {.image=gImage_red18, .xLen=32, .yLen=40},
        {.image=gImage_red36, .xLen=38, .yLen=40},
        {.image=gImage_red54, .xLen=40, .yLen=38},
        {.image=gImage_red72, .xLen=40, .yLen=32},

        {.image=gImage_red90, .xLen=38, .yLen=26},
        {.image=gImage_red108, .xLen=40, .yLen=32},
        {.image=gImage_red126, .xLen=40, .yLen=38},
        {.image=gImage_red144, .xLen=38, .yLen=40},
        {.image=gImage_red162, .xLen=32, .yLen=40},

        {.image=gImage_red180, .xLen=26, .yLen=38},
        {.image=gImage_red198, .xLen=32, .yLen=40},
        {.image=gImage_red216, .xLen=38, .yLen=40},
        {.image=gImage_red234, .xLen=40, .yLen=38},
        {.image=gImage_red252, .xLen=40, .yLen=32},

        {.image=gImage_red270, .xLen=38, .yLen=26},
        {.image=gImage_red288, .xLen=40, .yLen=32},
        {.image=gImage_red306, .xLen=40, .yLen=38},
        {.image=gImage_red324, .xLen=38, .yLen=40},
        {.image=gImage_red342, .xLen=32, .yLen=40},
};

const TankImage_T greenTankImage[20] = {
        {.image=gImage_green0, .xLen=26, .yLen=38},
        {.image=gImage_green18, .xLen=32, .yLen=40},
        {.image=gImage_green36, .xLen=38, .yLen=40},
        {.image=gImage_green54, .xLen=40, .yLen=38},
        {.image=gImage_green72, .xLen=40, .yLen=32},

        {.image=gImage_green90, .xLen=38, .yLen=26},
        {.image=gImage_green108, .xLen=40, .yLen=32},
        {.image=gImage_green126, .xLen=40, .yLen=38},
        {.image=gImage_green144, .xLen=38, .yLen=40},
        {.image=gImage_green162, .xLen=32, .yLen=40},

        {.image=gImage_green180, .xLen=26, .yLen=38},
        {.image=gImage_green198, .xLen=32, .yLen=40},
        {.image=gImage_green216, .xLen=38, .yLen=40},
        {.image=gImage_green234, .xLen=40, .yLen=38},
        {.image=gImage_green252, .xLen=40, .yLen=32},

        {.image=gImage_green270, .xLen=38, .yLen=26},
        {.image=gImage_green288, .xLen=40, .yLen=32},
        {.image=gImage_green306, .xLen=40, .yLen=38},
        {.image=gImage_green324, .xLen=38, .yLen=40},
        {.image=gImage_green342, .xLen=32, .yLen=40},
};
